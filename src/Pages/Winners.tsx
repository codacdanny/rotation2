...
const Winners = () => {
  const winnersData: Winner[] = [
    ...
    { username: "User124", amount: "RC200" },
    { username: "User125", amount: "RC200" },
    { username: "User126", amount: "RC200" },
    { username: "User127", amount: "RC200" },
    { username: "User128", amount: "RC200" },
    { username: "User129", amount: "RC200" },
  ...
  return (
    <Page_Backround>
      <Flex color="#24133F" flexDirection="column" gap="2rem">
        ...
        <Text>
          These are people who registered with your referaal link and won games.
        </Text>
        <Nav />
